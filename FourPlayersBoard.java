    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer mp = MediaPlayer.create(FourPlayersBoard.this, R.raw.clicksound);
                mp.start();
            }
    ...
    private void showToastForColor(String color) {
        switch (color) {
            case "Red":
                ...
                MediaPlayer mpr = MediaPlayer.create(FourPlayersBoard.this, R.raw.win);
                mpr.start();
            ...
            case "Blue":
                ...
                MediaPlayer mpb = MediaPlayer.create(FourPlayersBoard.this, R.raw.win);
                mpb.start();
            ...
            case "Yellow":
                ...
                MediaPlayer mpy = MediaPlayer.create(FourPlayersBoard.this, R.raw.win);
                mpy.start();
            ...
            case "Green":
                ...
                MediaPlayer mpg = MediaPlayer.create(FourPlayersBoard.this, R.raw.win);
                mpg.start();
            ...
            case "Orange":
                ...
                MediaPlayer mpo = MediaPlayer.create(FourPlayersBoard.this, R.raw.win);
                mpo.start();
            ...
            case "Pink":
                ...
                MediaPlayer mpp = MediaPlayer.create(FourPlayersBoard.this, R.raw.win);
                mpp.start();
