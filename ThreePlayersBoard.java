...
public class ThreePlayersBoard extends AppCompatActivity {
    ...
    private TextView usernameTextView1, usernameTextView2, usernameTextView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_players_board);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer mp = MediaPlayer.create(ThreePlayersBoard.this, R.raw.clicksound);
                mp.start();
            }
    ...
    private void showToastForColor(String color) {
        switch (color) {
            case "Red":
                ...
                MediaPlayer mpr = MediaPlayer.create(ThreePlayersBoard.this, R.raw.win);
                mpr.start();
            ...
            case "Blue":
                ...
                MediaPlayer mpb = MediaPlayer.create(ThreePlayersBoard.this, R.raw.win);
                mpb.start();
                break;
            ...
            case "Yellow":
                ...
                MediaPlayer mpy = MediaPlayer.create(ThreePlayersBoard.this, R.raw.win);
                mpy.start();
                break;
            ...
            case "Green":
                ...
                MediaPlayer mpg = MediaPlayer.create(ThreePlayersBoard.this, R.raw.win);
                mpg.start();
                break;
            ...
            case "Orange":
                ...
                MediaPlayer mpo = MediaPlayer.create(ThreePlayersBoard.this, R.raw.win);
                mpo.start();
            ...
            case "Pink":
                ...
                MediaPlayer mpp = MediaPlayer.create(ThreePlayersBoard.this, R.raw.win);
                mpp.start();
